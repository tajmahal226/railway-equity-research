...
export const AI_PROVIDER_REGISTRY: Record<string, (apiKey: string) => ProviderConfig> = {
  ...
  cohere: (apiKey) => createProviderConfig(apiKey, "cohere", "authorization"),
  together: (apiKey) => createProviderConfig(apiKey, "together", "authorization"),
  groq: (apiKey) => createProviderConfig(apiKey, "groq", "authorization"),
  perplexity: (apiKey) => createProviderConfig(apiKey, "perplexity", "authorization"),

...
Make it as detailed as possible, aim for 15 pages or more, the more the better, include ALL the learnings from research.
Please use prose, bullets, and tables where appropriate, but make sure you really explain things clearly, particularly techncial details.
